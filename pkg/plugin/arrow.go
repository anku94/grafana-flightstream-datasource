// Adapted from grafana-flightsql-datasource plugin
// Apache 2.0 License, see https://github.com/influxdata/grafana-flightsql-datasource
// Original author: InfluxData
// Modified by: Ankush Jain
